...
Meter.prototype = {
    ...
    _drawBaseScale: function (n) {
        ...
        var radius = this._conf.showBall ? this._conf.ballRadius : 0;
        var tempHeight = (this._conf.margin + radius) * 2 - this._ctx.canvas.height;
    ...
    _drawCursor (n) {
        ...
        this._ctx.beginPath();
        this._ctx.save();
        this._ctx.translate(-(this._conf.tempWidth / 2 + this._conf.offset) * n, -radius * 2 + val);
